...
| **4** — Client MVP | **In progress** | **Shipped:** [OpenAPI client](#phase-4--openapi-typed-client-bootstrap) + [routing + session UI](#phase-4--routing--session-ui) + [pages + editor + register](#phase-4--pages-list-editor--register) + **[collab decrypt + REST append](#phase-4--collab-decrypt--yjs--post-append)** + **[register crypto parity](#phase-4--register-crypto-parity)** (real keyrings, private personal group, msgpack defaults). **Next:** Tiptap; **MSW/Playwright**; **groups** UX; optional deterministic demo keyring for CI. **Phase 3** still: [collab + realtime WebSocket](#not-started-phase-3--realtime--collab-websocket). |
