...
export {}
declare global {
  const $quasar: typeof import('src/code/helpers')['$quasar']
  ...
  const internals: typeof import('src/code/internals')['internals']
  const isProxy: typeof import('vue')['isProxy']
  const isReactive: typeof import('vue')['isReactive']
  const isReadonly: typeof import('vue')['isReadonly']
  const isRef: typeof import('vue')['isRef']
  const mainLogger: typeof import('src/code/logger')['mainLogger']
  ...
  const pagesStore: typeof import('src/code/stores')['pagesStore']
  ...
  const route: typeof import('src/code/helpers')['route']
  const router: typeof import('src/code/helpers')['router']
  ...
  const trpcClient: typeof import('src/code/trpc')['trpcClient']
  const uiStore: typeof import('src/code/stores')['uiStore']
